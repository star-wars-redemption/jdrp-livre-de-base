...
Entre parenthèse après les légats on trouve la cadence de tir de l’arme. En nombre de projectile maximum envoyé par tour. Attention dès que le nombre de projectiles envoyé dépasse 1, il y a un malus de -2 pour le recul.
